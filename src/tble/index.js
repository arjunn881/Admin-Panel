  ...
  return (
    <div className="main">
      ...
      <div className="info-wrapper">
        ...
        {selectedUser && (
          <div key={selectedUser.city}>
            <div className="name">
              <span>
                UserSelected : <span>{selectedUser.firstName}</span>
            ...
            <div className="des">
              <span>
                Description:
                <br /> <p> {selectedUser.description}</p>
              </span>
            </div>

            <div className="address">
              <p>Address : {selectedUser.address.streetAddress}</p>
              <p>City : {selectedUser.address.city}</p>
              <p>State : {selectedUser.address.state}</p>
              <p>Zip : {selectedUser.address.zip}</p>
            </div>
          </div>
        )}
      </div>
